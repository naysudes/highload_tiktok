...
CDN - на хранение видео, небольшие CDN - на предзагруженные популярные тик-токи. В качестве базы данных будем использовать PostgreSQL. В отдельный сервис - аналитики и составления рекомендаций.
